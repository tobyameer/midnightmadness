    ...
    .map(
      (a) => `
        <div style="background: #2A1F20; padding: 16px; border-radius: 8px; margin: 8px 0; border-left: 4px solid #d74632;">
          ...
          <div style="color: #cccccc; font-size: 14px; margin: 4px 0;">Email: ${a.email}</div>
          <div style="color: #cccccc; font-size: 14px; margin: 4px 0;">Phone: ${a.phone}</div>
          <div style="color: #cccccc; font-size: 14px; margin: 4px 0;">National ID: ${a.nationalId}</div>
          <div style="color: #cccccc; font-size: 14px; margin: 4px 0;">Gender: ${a.gender}</div>
        </div>
      `
    )
    .join("");
        ...
        <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="max-width:600px;background:#1A1314;border-radius:16px;overflow:hidden;border:1px solid rgba(215,70,50,0.3);">
          <tr>
            <td style="padding:32px;text-align:center;background:linear-gradient(135deg,#d74632,#a22e1f);color:#ffffff;">
              ...
              <p style="margin:8px 0 0;font-size:15px;color:#ffffff;">Your Clear Vision Ticket is Ready!</p>
            </td>
          </tr>
          <tr>
            <td style="padding:32px 36px 24px 36px;color:#ffffff;">
              <h2 style="color:#d74632;margin:0 0 20px 0;font-size:24px;">Welcome to Clear Vision!</h2>
              ...
              <div style="background:#2A1F20;padding:20px;border-radius:12px;margin:20px 0;text-align:center;">
                ...
                <p style="margin:0;font-size:16px;color:#ffffff;">We can't wait to see you at Clear Vision!</p>
